...
/** Presto table options. */
public class PrestoTableOptions {
    ...
    public PrestoTableOptions() {
        ImmutableList.Builder<PropertyMetadata<?>> builder = ImmutableList.builder();
        List<PrestoTableOptionUtils.OptionInfo> optionInfos =
                PrestoTableOptionUtils.getOptionInfos();
        optionInfos.forEach(
                item -> builder.add(stringProperty(item.trinoOptionKey, "option", null, false)));
